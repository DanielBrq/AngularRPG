...
export class WaterDominion extends SpecialSkill {
    ...
    public getDescription(): string { return i18nTranslation('effects.special.waterDominion.description', { coldDmg: () => this._coldDmgBonus * 100, heatResistance: () => this._heatResistanceBonus * 100, speedBonus: () => this._speedBonus * 100, duration: () => this._duration }); }
}
